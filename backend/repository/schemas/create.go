...
func (c *Client) CreateTx(ctx context.Context, tx *gorm.DB, options *CreateOptions) (schema *model.Schema, err error) {
	...
	err = c.userSchemas.InsertTx(ctx, tx, &model.UserSchema{
